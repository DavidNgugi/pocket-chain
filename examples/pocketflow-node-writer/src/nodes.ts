import { AsyncNode, Node, SharedStore } from 'pocketflow-node';
 ...
 */
export class AnalyzeRequirements extends AsyncNode {
  async prepAsync(shared: SharedStore): Promise<ContentRequest> {
  ...
  async execAsync(request: ContentRequest): Promise<ContentOutline> {
  ...
  async postAsync(shared: SharedStore, prepRes: ContentRequest, execRes: ContentOutline): Promise<void> {
 ...
 */
export class GenerateContent extends AsyncNode {
  async prepAsync(shared: SharedStore): Promise<{ outline: ContentOutline; request: ContentRequest }> {
    console.log('🔍 Prepping GenerateContent node');
    console.log('🔍 Shared:', shared);
    console.log('🔍 Outline:', shared.outline);
    console.log('🔍 Content Request:', shared.contentRequest);
    return {
  ...
  async execAsync(inputs: { outline: ContentOutline; request: ContentRequest }): Promise<ContentSection[]> {
  ...
  async postAsync(shared: SharedStore, prepRes: { outline: ContentOutline; request: ContentRequest }, execRes: ContentSection[]): Promise<void> {
 ...
 */
export class OptimizeSEO extends AsyncNode {
  async prepAsync(shared: SharedStore): Promise<{ sections: ContentSection[]; request: ContentRequest }> {
    return {
  ...
  async execAsync(inputs: { sections: ContentSection[]; request: ContentRequest }): Promise<SEOAnalysis> {
  ...
  async postAsync(shared: SharedStore, prepRes: { sections: ContentSection[]; request: ContentRequest }, execRes: SEOAnalysis): Promise<void> {
 ...
 */
export class AdaptStyle extends AsyncNode {
  async prepAsync(shared: SharedStore): Promise<{ sections: ContentSection[]; request: ContentRequest }> {
    return {
      sections: shared.contentSections || [],
      request: shared.contentRequest || { topic: '', type: 'article', targetAudience: 'general', tone: 'professional', length: 'medium', keywords: [] }
  ...
  async execAsync(inputs: { sections: ContentSection[]; request: ContentRequest }): Promise<ContentSection[]> {
    const { sections, request } = inputs;
  ...
  async postAsync(shared: SharedStore, prepRes: { sections: ContentSection[]; request: ContentRequest }, execRes: ContentSection[]): Promise<void> {
 ...
 */
export class CreateFinalOutput extends AsyncNode {
  ...
  async postAsync(shared: SharedStore, prepRes: any, execRes: string): Promise<void> {
